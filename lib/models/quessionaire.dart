...
class Quessionaire {
  ...
  static Future<Task> getQuessionaire() {
    ...
    List<Step> steps = [
      InstructionStep(
        title: 'A Guide To Depression, Anxiety and\n Stress Scale \n(DASS 21) \n\nBy Fernando Gomez - Consultant Clinical Psychologist',
        text: 'The DASS 21 is a 21 item self report questionnaire designed to measure the severity of a range of symptoms common to both'
